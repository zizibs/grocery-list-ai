...
-- First grant schema permissions and table permissions
-- Grant permissions to both authenticated and anon users
GRANT USAGE ON SCHEMA public TO authenticated, anon, service_role;

-- Grant permissions to authenticated users for all operations
GRANT ALL ON ALL TABLES IN SCHEMA public TO authenticated;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO authenticated;
GRANT ALL ON ALL FUNCTIONS IN SCHEMA public TO authenticated;

-- Grant specific permissions to anon (needed for authentication)
...
-- Ensure future tables have the same grants
